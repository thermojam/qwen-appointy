                    ...
                    <div className="grid gap-4 md:grid-cols-3 mb-8">
                        ...
                        <Card className="rounded-3xl">
                            <CardContent className="p-6">
                                <div className="flex items-center gap-4">
                                    <div
                                        className="w-12 h-12 rounded-2xl bg-success/10 flex items-center justify-center">
                            ...
                            <Card key={review.id} className="card-hover rounded-3xl border-border/50">
                                <CardContent className="p-6">
                                    <div className="flex items-start gap-4">
                                        {/* Avatar */}
                                        <div
                                            className="w-12 h-12 rounded-2xl bg-[#F1F5F9] flex items-center justify-center flex-shrink-0">
